...
<div class="caja1">
        <div class="todositems">
            <h1>FORO.ET20</h1>
            <form action="QUE OPINA DE MASSA.php" method="post">
              <div class="uno">
             ...
             <div class="uno"> 
                Tema de interes:<br>¿Que opina de sergio massa?<br>
            </div>
...
$conexion->query("INSERT INTO `interes-massa` (`ID`, `Nickname`, `Comentario`, `Fecha`) VALUES (NULL, '$nombre', '$texto', '$fecha');");
}
