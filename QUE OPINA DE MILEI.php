...
<div class="caja1">
        <div class="todositems">
            <h1>FORO.ET20</h1>
            <form action="QUE OPINA DE MILEI.php" method="post">
             ...
             <div class="uno"> 
                Tema de interes:<br>¿Que opina de sergio milei?<br>
            </div>
...
$fecha=date("y/m/d");$conexion->query("INSERT INTO `interes-millei` (`ID`, `Nickname`, `Comentario`, `Fecha`) VALUES (NULL, '$nombre', '$texto', '$fecha');");
}
